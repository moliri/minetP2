...
export MINET_IPADDR="10.10.145.19"
...
xterm -fg cyan -bg black -sb -sl 5000 -T http_client -e "bin/http_client u 10.10.145.30 10111 README" & echo $! >> pids_client
#xterm -fg cyan -bg black -sb -sl 5000 -T http_client -e "bin/http_client u 10.10.145.20 10088 README > result.txt" & echo $! >> pids_client
